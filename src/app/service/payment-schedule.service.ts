...
baseUrl = `${localStorage.getItem('ServerUrl')}/PaymentSchedule/ListPaymentSchedule`;
  ...
  public insert(paymentschedule: PaymentSchedule) {
    return this.http.post(`${this.baseUrl}/Insert`, paymentschedule);
  }
  public edit(role) {
